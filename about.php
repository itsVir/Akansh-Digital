...
<head>
	<meta charset="utf-8">
	<title>Vitors Business HTML-5 Template | About</title>
	...
	<style>
		.counter-one .container {
			.counter-one .container {
				...
				flex-wrap: wrap;
				/* Wrap elements if the container is too small */
				gap: 20px;
				/* Adds space between items for better responsiveness */
				padding: 20px;
						...
						<div class="about-one__left">
							<div class="about-one__img-box wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
								<div class="about-one__img">
									<img src="images/resource/office.jpg" alt="">
								</div>
								<div class="about-one__img-2">
									<img src="images/resource/office-recorce.jpg" alt="">
								</div>
					...
					<div class="col-xl-6">
						<div class="about-one__right wow fadeInRight" data-wow-delay="300ms">
							<div class="section-title text-left">
								...
								<h2 class="section-title__title">We're sharp brands creators open
									for any new collabs
								</h2>
							</div>
							<p class="about-one__text">Grow brands through bold and strategic creative, focused on
								searching new ways to showcase user content on digital support and envisioning the
								future arts.</p>
				...
				<div class="row">
					<div class="col-xl-6">
						<div class="about-two__left">
							<div class="section-title text-left">
								<div class="section-title__tagline-box">
									<span class="section-title__tagline">. : Trusted website design agency : .</span>
								</div>
								<h2 class="section-title__title">Get Now Great Design Solution
								</h2>
							</div>
							<p class="about-two__text-1">We combine strategy with marketing, design</p>
							<p class="about-two__text-2">Analysis of the current business model, assessment of the
								company’s compete activeness and market position, financial condition, as well as all
								their minimization in the medium long-term prospects.</p>
							<div class="about-two__progress">
								<div class="about-two__progress-icon">
									<img src="images/icons/about-two-progress-icon.png" alt="">
								</div>
								<div class="progress-levels">
									<!--Skill Box-->
									<div class="progress-box">
										<div class="inner count-box">
											<div class="text">Digital Market Expert</div>
											<div class="bar">
												<div class="bar-innner">
													...
													<div class="bar-fill" data-percent="89"></div>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="about-two__user-and-btn-box">
								<div class="about-two__user-box">
									...
									<div class="about-two__user-content">
										<h5 class="about-two__user-name">Vrushbh Jansari</h5>
										<p class="about-two__user-sub-title">CEO</p>
									</div>
								</div>
								<div class="about-two__user-btn-box">
									<a href="pdf/Akansh-Digital-Detailes.pdf" class="about-two__user-btn" download>
										<br>Download<br>PDF <span class="icon-arrow-upper-right"></span>
									</a>
				...
				<div class="row">
					...
					<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
						<div class="counter-one__single">
							<div class="counter-one__shape-1" style="background-image: url(images/shapes/counter-one-shape-1.jpg);"></div>
							...
							<p class="counter-one__text">Projects <br>
								Completed</p>
						</div>
					</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
						<div class="counter-one__single">
							...
							<p class="counter-one__text">Satisfied <br>
								Customers</p>
						</div>
					</div>
					<!-- Counter One Single End -->
					...
					<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
						<div class="counter-one__single">
							...
							<p class="counter-one__text">Years Great <br>
								Experience</p>
						</div>
					</div>
					<!-- Counter One Single End -->
					...
					<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
						<div class="counter-one__single">
							...
							<div class="counter-one__count-box">
								<h3 class="odometer" data-count="02">00</h3>
							</div>
							<p class="counter-one__text">Honorable <br>
								Award</p>
						</div>
					</div>
					<!-- Counter One Single End -->

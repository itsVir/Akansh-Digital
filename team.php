...
<head>
	<meta charset="utf-8">
	<title>Vitors Business HTML-5 Template | Team</title>
					...
					<div class="row">
						...
						<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
							<div class="team-one__single">
								...
								<div class="team-one__content">
									<h3 class="team-one__title"><a href="team.html">Vrushabh Jansari</a></h3>
						...
						<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
							<div class="team-one__single">
								...
								<div class="team-one__content">
									<h3 class="team-one__title"><a href="team.html">Riddhi Jansari</a></h3>
									<p class="team-one__sub-title">HR</p>
								</div>
							</div>
						</div>
						<!--Team One Single End-->
						...
						<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
							<div class="team-one__single">
								...
								<div class="team-one__content">
									<h3 class="team-one__title"><a href="team.html">Vrutik Goti</a></h3>
									<p class="team-one__sub-title">Application Developer</p>
								</div>
							</div>
						</div>
						<!--Team One Single End-->
						...
						<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="400ms">
							<div class="team-one__single">
								...
								<div class="team-one__content">
									<h3 class="team-one__title"><a href="team.html">Mahaveer Vala</a></h3>
									<p class="team-one__sub-title">Web Devloper</p>
								</div>
							</div>
						</div>
						<!--Team One Single End-->
						...
						<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="500ms">
							<div class="team-one__single">
								...
								<div class="team-one__content">
									<h3 class="team-one__title"><a href="team.html">Nawaz Sherasiya</a></h3>
									<p class="team-one__sub-title">Node Devloper</p>
								</div>
							</div>
						</div>
						<!--Team One Single End-->
						...
						<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="600ms">
							<div class="team-one__single">
								...
								<div class="team-one__content">
									<h3 class="team-one__title"><a href="team.html">Bhumikakumari Tabiyad</a></h3>
									<p class="team-one__sub-title">Graphic Designer</p>
								</div>
							</div>
						</div>
						<!--Team One Single End-->
